...
$thispage_title_icon = '<i class="pe-7s-cloud-upload icon-gradient bg-happy-itmeo"></i> ';
$thispage_help = $l['hp_import_xml_users'];
...
<label for="userfile"><?php echo ucfirst($l['w_upload_file']); ?></label>
<input class="form-control-file" type="file" name="userfile" id="userfile" title="<?php echo ucfirst($l['h_upload_file']); ?>" />
</div>
<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo K_MAX_UPLOAD_SIZE ?>" />


<fieldset class="position-relative row form-group">
<legend class="col-form-label col-sm-2" title="<?php echo $l['h_file_type']; ?>"><?php echo 'Tipe file'; ?></legend>


<div class="col-sm-10">

<div class="position-relative custom-radio custom-control">
	<input class="custom-control-input" type="radio" name="file_type" id="file_type_xml" value="1" checked="checked" title="<?php echo $l['h_file_type_xml']; ?>" />
	<label for="file_type_xml" class="custom-control-label">XML</label>
</div>

<div class="position-relative custom-radio custom-control">
	<input class="custom-control-input" type="radio" name="file_type" id="file_type_tsv" value="2" title="<?php echo $l['h_file_type_tsv']; ?>" />
	<label for="file_type_tsv" class="custom-control-label">TSV</label>
</div>

<div class="position-relative custom-radio custom-control">
	<input class="custom-control-input" type="radio" name="file_type" id="file_type_xlsx" value="3" title="<?php echo 'XLSX'; ?>" />
	<label for="file_type_xlsx" class="custom-control-label">
		
		XLSX&nbsp;<a href="../../template/tcexam_users_template_awal.xlsx" class="mr-2 badge badge-pill badge-success"><i class="fas fa-file-excel"></i> Download Template User</a>
		</label>
...
F_submit_button_alt("upload", $l['w_upload'], $l['h_submit_file'], "btn btn-primary btn-block");
