...
// $thispage_help = 'Pada halaman ini, seorang admin atau user level 2 memiliki hak untuk melakukan update terdapat instalasi TMF yang telah terpasang sebelumnya. Anda membutuhkan file dengan ekstensi zip yang disediakan oleh pengembang.';
